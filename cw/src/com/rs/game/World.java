...
public final class World {
	...
	private static void addSquealOfFortuneSpin() {
        CoresManager.slowExecutor.scheduleWithFixedDelay(new Runnable() {
                @Override
                public void run() {
                        try {
	 ...
	 * @param string
	 */
	public static void sendWorldMessage(String string) {
		for (Player other : World.getPlayers()) {
			other.getPackets().sendGameMessage(string);
		}
