...
public class NPC extends Entity implements Serializable {
	...
	public void drop() {
		try {
			...
			final int[] charms = { 12158, 12159, 12160, 12161, 12162, 12163,
	 ...
	 */
	 public void npcDied(final Player player, int npcId) {
		 ...
		 case 8597:
			    SoulWars.aocDeaths++;
			    player.out("You have murdered the avatar of creation!");
				break;
	    	case 8596:
				SoulWars.aodDeaths++;
				 player.out("You have murdered the avatar of destruction!");
				break;
	    	case 8599:
