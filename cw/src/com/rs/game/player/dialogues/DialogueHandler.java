...
import com.rs.game.player.dialogues.lostcity.LostCityStart;
...
public final class DialogueHandler {
	...
	public static final void init() {
		try {
			...
			handledDialogues.put("AreaDialogue", (Class<Dialogue>) Class.forName(AreaDialogue.class.getCanonicalName()));
			handledDialogues.put("TeleportD", (Class<Dialogue>) Class.forName(TeleportD.class.getCanonicalName()));
			handledDialogues.put("WAnimator", (Class<Dialogue>) Class.forName(WAnimator.class.getCanonicalName()));
			handledDialogues.put("Shanomi", (Class<Dialogue>) Class.forName(Shanomi.class.getCanonicalName()));
			handledDialogues.put("SkillTransportation", (Class<Dialogue>) Class.forName(SkillTransportation.class.getCanonicalName()));
			handledDialogues.put("PenguinD", (Class<Dialogue>) Class.forName(PenguinD.class.getCanonicalName()));
			handledDialogues.put("NomadSw", (Class<Dialogue>) Class.forName(NomadSw.class.getCanonicalName()));
			handledDialogues.put("collectItems", (Class<Dialogue>) Class.forName(collectItems.class.getCanonicalName()));
			handledDialogues.put("ZombieMonk", (Class<Dialogue>) Class.forName(ZombieMonk.class.getCanonicalName()));
			handledDialogues.put("LostCityStart", (Class<Dialogue>) Class.forName(LostCityStart.class.getCanonicalName()));
			handledDialogues.put("Shamus", (Class<Dialogue>) Class.forName(Shamus.class.getCanonicalName()));
			handledDialogues.put("Vannaka", (Class<Dialogue>) Class.forName(Vannaka.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
