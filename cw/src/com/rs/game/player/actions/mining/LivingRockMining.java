...
public class LivingRockMining extends Action {

    public static enum LivingRockDefs {

        LIVING_ROCK_STRIKER(73, 5, 15263, 1, 0),
        LIVING_ROCK_PATRIARCH(30, 5, 15263, 1, 0);
        private int level;
        private double xp;
        private int oreId;
        ...
        private LivingRockDefs(int level, double xp, int oreId,
    ...
    private NPC rock;
    private LivingRockDefs definitions;
    private int emoteId;
    private int pickaxeTime;

    public LivingRockMining(NPC rock, LivingRockDefs definitions) {
        this.rock = rock;
