...
public final class Settings {
	 ...
	 */
	public static final String SERVER_NAME = "EoCW";
	public static final int PORT_ID = 43594;
	public static final String LASTEST_UPDATE = "<col=7E2217>";
	 ...
	 * Link settings
	 */
	public static final String WEBSITE_LINK = "http://www.NRS3server.info";
	public static final String FORUMS_LINK = "http://www.NRS3server.info/forums.html";
	public static final String ITEMLIST_LINK = "http://www.itemdb.biz/";
	public static final String ITEMDB_LINK = "http://itemdb.biz/";
	public static final String VOTE_LINK  = "http://NRS3server.info/forums.html";
	public static final String DONATE_LINK = "http://NRS3server.info/forums.html";	
	public static final String HIGHSCORES_LINK = "http://NRS3server.info";
	 ...
	 */
	public static final String GUI_SIGN = "EoCW GUI";
	...
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2441, 3088, 0);
	public static final WorldTile RESPAWN_PLAYER_LOCATION = new WorldTile(2441, 3088, 0);
	public static final WorldTile HOME_PLAYER_LOCATION = new WorldTile(2441, 3088, 0);
	...
	public static int PLAYER_COUNT = 30; // enhancment
	...
	public static String[] DONATOR_ITEMS = { "primal", /* "virtus", "pernix", */
		"promethium", "", "thok's", "trident" };
	
	public static String[] EXTREME_DONATOR_ITEMS = {"cyrstal key", "auspicious katana", 
			"Yellow Partyhat", "Purple Partyhat", "White Partyhat", "Green Partyhat", "Blue Partyhat", "Red Partyhat"};
